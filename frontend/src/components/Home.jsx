                ...
                <div className=" space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <form className="space-y-4 md:space-y-6" action="" onSubmit={handleForm}>
                    <div>
                      ...
                      <input type="email" name="email" pattern=".+@aua\.ma" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@aua.com" required onChange={(e)=>{setCredentials({email:e.target.value,password:credentials.password})}} value={credentials.email}/>
                    </div>
                    <div>
